...
[DependsOn(
    // ProjectName
    typeof(MicroserviceCenterHttpApiModule),

    typeof(AbpEntityFrameworkCoreSqlServerModule),
    typeof(AbpAspNetCoreMvcModule),
    typeof(AbpAutofacModule)
)]
public class MicroserviceCenterHostModule : AbpModule
{
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.ApplicationName = MicroserviceCenterDomainOptions.ApplicationName;
        ...
        {
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "MicroserviceCenter.HttpApi.xml"), true);
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "MicroserviceCenter.UseCase.xml"), true);
        });
